...
class BaseModel(typing.Protocol):
    ...
    @abc.abstractmethod
    def build(
        self, hyperparams: dict[str, typing.Any], envFactory: EnvType
    ) -> typing.Self:
        """
        ...
        raise NotImplementedError(
            "TrainableModel.build must be supported by the subclass"
        )

    @abc.abstractmethod
    def train(
        self, timesteps: int, *args: typing.Any, **kwargs: typing.Any
    ) -> typing.Self:
        """
        Training the model.
        ...
        """
        raise NotImplementedError(
            "TrainableModel.train must be supported by the subclass"
        )

    @abc.abstractmethod
    def evaluate(
        self, eval_func: EvalFuncType, *args: typing.Any, **kwargs: typing.Any
    ) -> EvalResultType:
        """
        ...
        """
        raise NotImplementedError(
            "TrainableModel.evaluate must be supported by the subclass"
        )
